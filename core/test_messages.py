...
def test_send_message(client):
    ...
    # The response might be in different formats depending on implementation
    # It could be a message object, a list of messages, or a response object with messages
